...
#define INTERNAL_CPPHDRS_ARCHIVING_BUILDER_REGISTER(...)

#define CPPHEADERS_DEFINE_ARCHIVE_METHODS(CLASSNAME, ...)           \
                                                                    \
  INTERNAL_CPPHDRS_ARCHIVING_BRK_TOKENS(#__VA_ARGS__);              \
  INTERNAL_CPPHDRS_NLOHMANN_JSON_REGISTER(CLASSNAME, __VA_ARGS__); \
  INTERNAL_CPPHDRS_ARCHIVING_BUILDER_REGISTER(CLASSNAME, __VA_ARGS__);
#endif
